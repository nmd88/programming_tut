...
describe('Hoisting', function () {
  ...
  it('Javascript loads functions and variables that need space in memory first', function () {
    ...
    function Universe() {
      ...
      function functionResult() { 
        //This function gets loaded at the top
        return 5;
      }
    }
  ...
  it('Hoisting functions with the same name get overridden', function () {
    function Universe() {
      function functionResult() { 
        //This function gets loaded at the top at first
        return 3;
      }
      return functionResult();

      function functionResult() { 
        //This function gets loaded at the after the first function, since it has the same name, the first function is destroyed
        return 5;
      }
    }
  ...
  it('Function Expressions are never hoisted', function () {
    function Universe() {
      ...
      var functionVariable = function functionResult() { 
        //This function is never reached since it exists after the return statement
        return 5;
      }
    }
